...
describe('Search The Site',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumplayoutHeader.searchTheSite)
      .insert(bumplayoutHeader.searchTheSite, chance.word())
      .resetHAR()
      .type(bumplayoutHeader.searchTheSite, '\u000d')
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        let eventFound = searchHAR.findEvent(result.entries, 'Text Search');
