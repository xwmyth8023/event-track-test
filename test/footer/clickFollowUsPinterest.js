...
describe('Click Follow Us Pinterest On Footer',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumplayoutFooter.followPinterest)
      .resetHAR()
      .click(bumplayoutFooter.followPinterest)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries, 'selection', 'follow us > pinterest')
