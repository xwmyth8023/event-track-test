...
describe('Click The Nest On Footer',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumplayoutFooter.theNestLogo)
      .resetHAR()
      .click(bumplayoutFooter.theNestLogo)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries, 'selection', 'visit our sister sites > the nest')
