...
describe('Click Follow Us Instagram On Footer',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumplayoutFooter.followInstagram)
      .resetHAR()
      .click(bumplayoutFooter.followInstagram)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries, 'selection', 'follow us > instagram')
