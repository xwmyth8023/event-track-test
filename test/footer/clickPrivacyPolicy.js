...
describe('Click Privacy Policy On Footer',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumplayoutFooter.privacyPolicy)
      .resetHAR()
      .click(bumplayoutFooter.privacyPolicy)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries, 'selection', 'privacy policy')
