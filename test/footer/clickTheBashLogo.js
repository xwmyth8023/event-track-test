...
describe('Click The Bash On Footer',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumplayoutFooter.theBashLogo)
      .resetHAR()
      .click(bumplayoutFooter.theBashLogo)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries, 'selection', 'visit our sister sites > the bash')
