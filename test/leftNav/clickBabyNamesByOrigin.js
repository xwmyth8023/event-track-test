...
describe('Click Baby Names By Origin On Left Navigation',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumpLayoutNav.babyNamesDropdown)
      .click(bumpLayoutNav.babyNamesDropdown)
      .wait(bumpLayoutNav.babyNamesByOrigin)
      .resetHAR()
      .click(bumpLayoutNav.babyNamesByOrigin)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries,'selection',"baby names by origin")
