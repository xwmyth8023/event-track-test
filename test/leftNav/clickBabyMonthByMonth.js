...
describe('Click Baby Month By Month On Left Navigation',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumpLayoutNav.babyDropdown)
      .click(bumpLayoutNav.babyDropdown)
      .wait(bumpLayoutNav.babyMonthByMonth)
      .resetHAR()
      .click(bumpLayoutNav.babyMonthByMonth)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries,'selection',"baby month by month")
