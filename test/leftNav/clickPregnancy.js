...
describe('Click Pregnancy On Left Navigation',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumpLayoutNav.pregnancy)
      .resetHAR()
      .click(bumpLayoutNav.pregnancy)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries,'selection',"pregnancy")
