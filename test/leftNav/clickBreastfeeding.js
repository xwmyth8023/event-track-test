...
describe('Click Baby On Left Navigation',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .wait(bumpLayoutNav.breastfeeding)
      .resetHAR()
      .click(bumpLayoutNav.breastfeeding)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries,'selection',"breastfeeding")
