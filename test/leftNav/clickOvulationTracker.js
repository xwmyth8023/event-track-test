...
describe('Click Ovulation Tracker On Getting Pregnant Section',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .wait(bumpLayoutNav.ovulationTracker)
      .resetHAR()
      .click(bumpLayoutNav.ovulationTracker)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries,'selection',"ovulation tracker")
