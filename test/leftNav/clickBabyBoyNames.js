...
describe('Click Baby Boy Names On Left Navigation',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .wait(bumpLayoutNav.babyBoyNames)
      .resetHAR()
      .click(bumpLayoutNav.babyBoyNames)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries,'selection',"baby boys names")
