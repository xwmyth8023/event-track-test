...
describe('Click Baby Name Lists On Left Navigation',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .wait(bumpLayoutNav.babyNameLists)
      .resetHAR()
      .click(bumpLayoutNav.babyNameLists)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries,'selection',"baby name lists")
