...
describe('Click Signs of Ovulation On Getting Pregnant Section',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumpLayoutNav.gettingPregnantDropdown)
      .click(bumpLayoutNav.gettingPregnantDropdown)
      .wait(bumpLayoutNav.signsOfOvulation)
      .resetHAR()
      .click(bumpLayoutNav.signsOfOvulation)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries,'selection',"signs of ovulation")
