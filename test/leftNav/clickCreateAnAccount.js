...
describe('Click Create An Account On Left Navigation',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .goto(homepageUrl)
      .wait(3000)
      .wait(bumpLayoutNav.accountDropdown)
      .click(bumpLayoutNav.accountDropdown)
      .wait(bumpLayoutNav.createAnAccount)
      .resetHAR()
      .click(bumpLayoutNav.createAnAccount)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries,'selection',"create an account")
