...
describe('Click Baby Names Home On Left Navigation',function(){
  this.timeout('300s')
  ...
  it('should fire event track',function(done){
    ...
    nightmare
      ...
      .wait(bumpLayoutNav.babyNamesHome)
      .resetHAR()
      .click(bumpLayoutNav.babyNamesHome)
      .wait(5000)
      .getHAR()
      .end()
      .then((result)=>{
        ...
        let selectionFound = searchHAR.findProperty(result.entries,'selection',"baby names home")
